...
const UserServices = ({service}) => {;
    ...
    return (
        ...
        <Table.Body className="divide-y divide-gray-25">
          ...
          {
            service?.map(s => <Table.Row className="bg-white">
            <Table.Cell>
            ...
            <Table.Cell>
              <p className="text-body-5 font-medium text-metal-500">{s?.bookingDate}</p>
              
            </Table.Cell>
            <Table.Cell>
              <p className="text-body-5 font-medium text-metal-500">${s?.price}</p>
            </Table.Cell>
            <Table.Cell>
