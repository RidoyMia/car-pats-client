...
import { useCreateSingleServiceMutation, useUpdatedSingleServiceMutation,  } from '../../../../components/store/ServicesApi/ServicesApi';
...
const UpdatedService = () => {
    ...
    const [updatedSingleService,{isLoading}] = useUpdatedSingleServiceMutation()
    const onSubmit = (data) => {
        ...
        axios.post(`https://api.imgbb.com/1/upload?expiration=600&key=${api}`, formData).then(result => {
            if (result?.data.data?.url) {
                ...
                updatedSingleService(productDataInfo).then(res =>{
