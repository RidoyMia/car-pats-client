...
import { useDeletedProductMutation, useGetAllProductsQuery } from '../../../../components/store/ProductApi/ProductApi';
...
const AdminAllProducts = () => {
  const navigate = useNavigate()
    ...
    const [deletedProduct,{isLoading:DeletedLoading}] = useDeletedProductMutation()
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          ...
          <button  className='bg-green-600 text-white px-2 py-1  rounded-sm' onClick={()=>navigate(`/adminDashboard/updateproduct/${r?._id}`)}>Update</button>
